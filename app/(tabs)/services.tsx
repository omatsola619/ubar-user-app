    ...
    return (
        <SafeAreaView style={styles.safe} edges={['top']}>
            ...
            <View style={styles.center}>
                <Ionicons name="grid-outline" size={64} color={UbarColors.border} />
                <Text style={styles.emptyTitle}>All Services</Text>
                <Text style={styles.emptySubtitle}>Browse all ubar services here</Text>
            </View>
        </SafeAreaView>
    );
}
